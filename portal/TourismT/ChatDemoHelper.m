...
{
    [self _clearHelper];
    //UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"您的账号在其他设备登录" message:nil delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    //[alertView show];
    [MBProgressHUD showPrompt:@"您的账号在其他设备登录"];
    [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
    [[tourHelper sharedInstance]logUrlOutView:nil];
}

- (void)userAccountDidRemoveFromServer
{
    [self _clearHelper];
    //UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"您的账号被清除" message:nil delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    //[alertView show];
    [MBProgressHUD showPrompt:@"您的账号被清除"];
    [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_LOGINCHANGE object:@NO];
    [[tourHelper sharedInstance]logUrlOutView:nil];
}
...
{
    NSMutableArray *viewControllers = [NSMutableArray arrayWithArray:_mainVC.navsameGroupvc.viewControllers];
    ChatViewController *chatViewContrller = nil;
    for (id viewController in viewControllers)
    {
