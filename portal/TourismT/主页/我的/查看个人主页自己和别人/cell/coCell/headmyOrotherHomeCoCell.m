...
#import "headmyOrotherHomeCoCell.h"

#import "NSString+check.h"

@interface headmyOrotherHomeCoCell ()
...
@implementation headmyOrotherHomeCoCell
...
- (void)setOneData:(peoHome_page *)oneData{
    ...
    if (oneData) {
        ...
        if (!oneData.user.nickName  || !oneData.user.nickName.length) {
        ...
        if (!oneData.user.signature || !oneData.user.signature.length) {
            oneData.user.signature = @"暂无签名";
        }
        ...
        self.one.text = [NSString stringWithFormat:@"%ld",oneData.travelCount];
        self.two.text = [NSString stringWithFormat:@"%ld",oneData.followCount];;
        self.three.text = [NSString stringWithFormat:@"%ld",oneData.followerCount];;
    }
}
@end
