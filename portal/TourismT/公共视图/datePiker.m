...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [change setBtnWithImage:nil font:PingFangSC_Regular(14) Title:@"取消" color:0x000000 alpa:0.54 forState:UIControlStateNormal];
        ...
        [okok setBtnWithImage:nil font:PingFangSC_Regular(14) Title:@"确定" color:0x000000 alpa:0.54 forState:UIControlStateNormal];
